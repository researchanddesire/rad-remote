...
<Accordion title="Encoder knobs are unresponsive or make erratic jumps">
...
1. **Update firmware** — Flash the latest firmware to both RADR and your device using the <a href="/ossm/guides/getting-started/web-flasher">Web Flasher</a>
