...
<AccordionGroup>
<Accordion title="One bumper button feels different or has no tactile feedback">
...
<Accordion title="What do the bumper buttons do?">
...
<AccordionGroup>
<Accordion title="How do I connect RADR to my OSSM?">
...
<Accordion title="Why won't RADR find my OSSM?">
...
<Accordion title="Is RADR compatible with older OSSM board versions?">
...
<AccordionGroup>
<Accordion title="My RADR makes a rattling sound when shaken">
...
<Accordion title="How do I charge RADR?">
...
<Accordion title="Who should I contact for RADR support?">
...
- **Discord:** [R+D Community Discord](https://discord.gg/DHTuY2AZYJ)
</Accordion>
