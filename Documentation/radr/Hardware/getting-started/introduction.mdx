...
<CardGroup cols={2}>
<Card title="PCB Design Files" icon="microchip" href="https://github.com/Research-And-Desire/RADR/tree/main/Hardware/Electronics">
Altium Designer project files, schematics, and Gerber files.
</Card>

<Card title="3D Print Files" icon="cube" href="https://github.com/Research-And-Desire/RADR/tree/main/Hardware/Print%20Files">
STEP and STL files for the enclosure and buttons.
</Card>

<Card title="Bill of Materials" icon="list" href="https://github.com/Research-And-Desire/RADR/tree/main/Hardware">
Complete parts list with supplier links.
</Card>

<Card title="Assembly Guide" icon="screwdriver-wrench" href="https://github.com/Research-And-Desire/RADR">
